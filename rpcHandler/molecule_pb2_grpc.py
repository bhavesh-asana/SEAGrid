...
class MoleculeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateMolecule = channel.unary_unary(
                '/com.smiles.server.controller.MoleculeService/CreateMolecule',
        ...
        self.ReadMolecule = channel.unary_unary(
                '/com.smiles.server.controller.MoleculeService/ReadMolecule',
        ...
        self.UpdateMolecule = channel.unary_unary(
                '/com.smiles.server.controller.MoleculeService/UpdateMolecule',
        ...
        self.DeleteMolecule = channel.unary_unary(
                '/com.smiles.server.controller.MoleculeService/DeleteMolecule',
        ...
        self.ListMolecule = channel.unary_unary(
                '/com.smiles.server.controller.MoleculeService/ListMolecule',
        ...
        self.GetMolecule = channel.unary_unary(
                '/com.smiles.server.controller.MoleculeService/GetMolecule',
                request_serializer=molecule__pb2.GetMoleculeRequest.SerializeToString,
...
def add_MoleculeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMolecule': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=molecule__pb2.GetMoleculeRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_struct__pb2.Struct.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'com.smiles.server.controller.MoleculeService', rpc_method_handlers)
...
class MoleculeService(object):
    ...
    def CreateMolecule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.smiles.server.controller.MoleculeService/CreateMolecule',
    ...
    def ReadMolecule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.smiles.server.controller.MoleculeService/ReadMolecule',
    ...
    def UpdateMolecule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.smiles.server.controller.MoleculeService/UpdateMolecule',
    ...
    def DeleteMolecule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.smiles.server.controller.MoleculeService/DeleteMolecule',
    ...
    def ListMolecule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.smiles.server.controller.MoleculeService/ListMolecule',
    ...
    def GetMolecule(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.smiles.server.controller.MoleculeService/GetMolecule',
            molecule__pb2.GetMoleculeRequest.SerializeToString,
